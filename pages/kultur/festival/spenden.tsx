...
export const getStaticProps: GetStaticProps<Props> = async ({ locale }) => {
    const circle = await getCircle('64bdbfb44bb258b9c71ac377', locale!);

    const pagesResponse = await getPayloadResponse<PaginatedDocs<Page>>(
        `/api/pages/?where[slug][equals]=festival-spenden&locale=${locale}`,
    );
            ...
            <div className="flex min-h-screen flex-col justify-between">
                ...
                <main id="content">
                    ...
                    <ContentWrapper className={clsx('mb-4 border-2 border-black p-2', isMd && '!-mt-0')}>
                        <FundraisingBox hash="ovajyy2pro60wtmi" />
                    </ContentWrapper>
